...
const metricCards = [
  ...
  { number: '2 000+', label: 'учеников' },
  { number: '4 000', label: 'человек на форуме\nмеждународной компании' },
  { number: '4 000 000+', label: 'прослушиваний\nнейрогруппы «Месяцы»' },
];

const achievements = [
  'авторы проекта «Месяцы» — первой нейрогруппы в России: 4 000 000+ прослушиваний и договор со старейшим российским лейблом CDLand Music',
          ...
          <ul className="flex flex-col gap-3">
            {achievements.map((item, i) => (
              ...
              >
                ...
                />
                <span className={`text-sm leading-relaxed sm:text-base ${i === 0 ? 'font-semibold text-white' : 'text-white/75'}`}>{item}</span>
              </motion.li>
            ))}
          </ul>
