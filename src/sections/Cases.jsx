      ...
      <div className="grid gap-6 md:grid-cols-2">
        {cases.map((item) => (
          <motion.div
            ...
            className="surface-muted rounded-3xl group relative overflow-hidden p-6"
          >
            ...
            <div className="relative z-10 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <span className="icon-wrap icon-glow h-10 w-10 text-genii-accent/80">
              ...
              <div className="rounded-2xl border border-white/10 bg-transparent px-4 py-3 text-sm text-genii-light/80">
